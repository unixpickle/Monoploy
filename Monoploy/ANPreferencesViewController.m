...
- (id)init {
    if ((self = [super init])) {
        ...
        compoundProbabilities.frame = CGRectMake(10, 40+50, 300, 44);
        compoundProbabilities.selectedSegmentIndex = [[ANPreferences sharedPreferences] compoundTurns];
        
        UILabel * compoundLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 15+50, 300, 20)];
        ...
        finderType.frame = CGRectMake(10, 135+50, 300, 44);
        finderType.selectedSegmentIndex = [[ANPreferences sharedPreferences] finderType];
        
        UILabel * finderLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 110+50, 300, 20)];
        ...
        jailScheme.frame = CGRectMake(10, 230+50, 300, 44);
        jailScheme.selectedSegmentIndex = [[ANPreferences sharedPreferences] jailOnlyDoubles];
        
        UILabel * jailLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 205+50, 300, 20)];
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    [[ANPreferences sharedPreferences] setFinderType:(ANFinderType)finderType.selectedSegmentIndex];
}
